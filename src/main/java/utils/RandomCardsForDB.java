...
public class RandomCardsForDB {
     ...
     * @param cards
     */
    private static void insertionCardsSetIntoDB(Set<Card> cards) throws SQLException, LoginToMySQLException, ClassNotFoundException {
        CardDAO clientDAO = new CardDAOImpl();
        cards.forEach(card -> {
            try {
     ...
     */
    private static Set<Card> generateRandomCreditCards() throws SQLException, ClassNotFoundException, LoginToMySQLException {
        Set<Card> cards = new HashSet<>();
        Set<Integer> clientIDs = new HashSet<>();
        ClientDAO clientDao = new ClientDAOImpl();
        clientDao.retrieveAll()
     ...
     * @return
     */
    public static Card generateCreditCardToClientID(int clientID) {
        Card card = new Card();
        card.cardNumber = generateNumber();
        card.clientID = clientID;
        card.creditLimit = generateLimit();
        card.balance = generateBalance();
